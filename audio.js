...
var listener;
var ground, groundGeo,groundpts;
init();
animate();
...
function init() {
	...
	controls = new THREE.FPS( camera, renderer.domElement, ground);
		...
		objLoader.load(obj, function ( object ) {
			object.traverse(function(child) {
				...
				if (child instanceof THREE.Mesh) {
					...
					groundGeo.center();
					groundGeo.scale(100,100,100);
					groundGeo = new THREE.Geometry().fromBufferGeometry(groundGeo);
					var material = new THREE.PointsMaterial();
					groundpts = new THREE.Points( groundGeo, material );
					scene.add (groundpts);
